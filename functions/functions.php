    ...
    if($_SERVER['REQUEST_METHOD'] == "POST") {
       ...
       if(strlen($first_name) > $max) {
        ...
        if(strlen($username) > $max) {
           $errors[] = "Your Username cannot be more then {$max} characters";
       }
        ...
        if(strlen($email) < $min) {
           $errors[] = "Your eMail cannot be more then {$max} characters";
       }
...
function register_user($first_name, $last_name, $username, $email, $password) {
    ...
    confirm($result);
        ...
        $msg = "please click the link below to activate your account
                ...
                ";
        $header = "From: noreply@nowhere.com";
    ...
    if($_SERVER['REQUEST_METHOD'] == "GET") {
        if(isset($_GET['email'])) {
            ...
            if(row_count($result) == 1) {
                ...
                $result2 = query($sql2);
                confirm($result2);
                set_message("<p class='bg-success'>You're account has been succesfully activated!</p>");
                redirect("./login.php");
    ...
    if($_SERVER['REQUEST_METHOD'] == "POST") {
        ...
        if(isset($_SESSION['token']) && $_POST['token'] === $_SESSION['token']) {
            ...
            if(email_exists($email)) {
                ...
                $message = "Please check for your password code {$validation_code}
                ...
                set_message("<p class='bg-success text-center'>Please check inbox or spam folder for password reset code</p>");
                redirect("./index.php");
...
function validate_code() {
    if(isset($_COOKIE['temp_access_code'])) {
        ...
        set_message("<p class='bg-danger'>SORRY WRONG VALIDATION CODE!!!</p>");
